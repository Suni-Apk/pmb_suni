            ...
            <div class="container">
                <div class="row flex-column justify-content-center">
                    ...
                    <div class="col-9 col-lg-5 mx-auto d-flex justify-content-center gap-3 mt-4">
                        <a href="{{ route('login') }}" class="btn bg-gradient-secondary" data-bs-toggle="tooltip"
                            data-bs-placement="left" title="Sudah punya akun?">Login</a>
                        <a href="{{ route('register') }}" class="btn bg-gradient-primary" data-bs-toggle="tooltip"
                            data-bs-placement="right" title="Belum mendaftar?">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
