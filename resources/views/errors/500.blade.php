...
<body class="overflow-hidden min-vh-100 p-4">
    ...
    <div class="error-section w-100 min-vh-80 shadow-xl row ms-0 justify-content-center align-items-center bg-light rounded-4">
        <div class="col-10 text-center col-md-4">
            <h1 class="text-dark"><span>5</span><span>0</span><span>0</span></h1>
            <h2 class="text-dark">Oops! Server Error</h2>
            <p class="mb-0 text-secondary">Maaf, server sedang mengalami masalah</p>
        </div>
    </div>
