                    ...
                    <div class="container-fluid pe-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navigation">
                            <ul class="navbar-nav pt-3 pt-sm-0 me-lg-2 flex-row">
                                ...
                                @else
                                    <div class="dropdown">
                                        <button class="btn btn-outline-dark dropdown-toggle mb-0 rounded-pill" data-bs-toggle="dropdown" id="dropdownLogin">
                                            <i class="fas fa-user-circle opacity-7 text-dark me-1"></i>
                                            Daftar
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownLogin">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('register','S1') }}">
                                                    <i class="fas me-3 fa-user"></i>
                                                Mahasiswa
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('register','kursus') }}">
