...
@section('content')
  ...
  @php
    $transactionDaftar = App\Models\Transaksi::where('user_id',Auth::user()->id)->where('jenis_tagihan','DaftarUlang')->where('status','berhasil')->first();
  @endphp
  @if (!$transactionDaftar)
      ...
      <div class="card">
        ...
        <h5 class="text-secondary font-weight-normal">Daftar Ulang Langsung</h5>
          ...
          <div class="d-flex align-items-center justify-content-center">
            <form action="{{route('mahasiswa.tagihan.daftar.ulang')}}" method="POST" class="d-flex align-items-center justify-content-center w-100">
              @csrf
              @method('GET')
              <div class="col-6 col-sm-4">
                <button name="jenis_pembayaran" value="cash" type="submit" class="btn bg-gradient-primary sm:w-50">
                  Cash
                </button>
              </div>
              <div class="col-6 col-sm-4">
                <button name="jenis_pembayaran" value="cicil" type="submit" class="btn bg-gradient-primary sm:w-50">
                  Cicil 3x
                </button>
              </div>
            </form>
  ...
  @elseif($transactionDaftar->jenis_pembayaran == 'cicil')
      @php
