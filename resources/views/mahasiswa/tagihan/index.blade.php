                            ...
                            <div class="row">
                                ...
                                <form action="{{ route('mahasiswa.tagihan.daftar.ulang') }}" method="POST">
                                    ...
                                    <div class="col-12 col-lg-8 mx-auto">
                                        <button type="submit" name="jenis_pembayaran" value="cicil"
                            ...
                            <table class="table align-items-center mb-0" id="templateTable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="text-secondary text-xs font-weight-bold ">Tidak Rutin</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="text-secondary text-xs font-weight-bold">2023</span>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0 text-center">Informatika</p>
                                        </td>
                                        <td class="text-center">
