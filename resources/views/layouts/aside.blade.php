<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 overflow-x-hidden"
        ...
        <div class="collapse navbar-collapse w-auto min-vh-70" id="sidenav-collapse-main">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="admin">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link {{Route::is('admin.') ? 'active' : ''}}" href="{{route('admin.admin.index')}}">
                                <span class="sidenav-mini-icon d-none d-xl-block"><i class="fas fa-border-all"></i></span>
        ...
        <ul class="navbar-nav overflow-x-hidden" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div class="collapse " id="template">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('pendaftaran_s1') }}">
                                <span class="sidenav-mini-icon d-none d-xl-block"><i class="fas fa-info"></i></span>
                                <span class="sidenav-normal">Form Biodata</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="{{ route('pendaftaran_s1_dokumen') }}">
                                <span class="sidenav-mini-icon d-none d-xl-block"><i class="fas fa-file"></i></span>
                                <span class="sidenav-normal">Form Dokumen</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    @endif
    <div class="sidenav-footer mx-3 nav-item">
        <a href="{{ route('logout') }}" class="btn bg-gradient-primary btn-tooltip mt-3 w-100 nav-link text-white" data-bs-toggle="tooltip" data-bs-placement="right" title="Logout" data-container="body" data-animation="true">
            <i class="fas fa-sign-out-alt"></i>
        </a>
    </div>
</aside>
