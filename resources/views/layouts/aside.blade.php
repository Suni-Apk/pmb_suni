    ...
    @if (Auth::user()->role == 'Admin')
        <div class="collapse navbar-collapse w-auto min-vh-70" id="sidenav-collapse-main">
            <ul class="navbar-nav overflow-x-hidden accordion" id="accordionSidebar">
                ...
                <li class="nav-item accordion-item">
                    <span role="button"
                        class="nav-link accordion-button collapsed d-flex justify-content-between pe-5"
                ...
                <li class="nav-item accordion-item">
                    ...
                    <div id="collapseSetting" class="accordion-collapse collapse" data-bs-parent="#accordionSidebar">
                        <div class="accordion-body py-1">
                            <a href="{{ route('billing') }}" class="nav-link">
                ...
                <li class="nav-item accordion-item">
                    <span role="button"
                        class="nav-link accordion-button collapsed d-flex justify-content-between pe-5"
                        data-bs-toggle="collapse" data-bs-target="#template" aria-expanded="false"
                        aria-controls="collapseSetting">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                    ...
                    <div id="template" class="accordion-collapse collapse" data-bs-parent="#accordionSidebar">
                        <div class="accordion-body py-1">
                            <a href="{{ route('forgot') }}" class="nav-link">
