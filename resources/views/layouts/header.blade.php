        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                    {{ Route::is('profile') ? 'Profile' : '' }} {{ Route::is('edit-profile') ? 'Edit Profile' : '' }}
                    {{ Route::is('change-password') ? 'Change Password' : '' }}
                </li>
            </ol>
            <h6 class="font-weight-bolder mb-0"> {{ Route::is('profile') ? 'Profile' : '' }}
                {{ Route::is('edit-profile') ? 'Edit Profile' : '' }}
                {{ Route::is('change-password') ? 'Change Password' : '' }}
            </h6>
        </nav>
