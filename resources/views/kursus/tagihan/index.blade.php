              ...
              <table class="table align-items-center mb-0" id="templateTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="{{route('kursus.tagihan.detail.spp',Auth::user()->name)}}" class="badge badge-sm bg-gradient-primary font-weight-bold text-xs mx-2" data-toggle="tooltip" data-original-title="Edit user">
                        Detail
                      </a>
                    </td>
                  </tr>
              ...
              <table class="table align-items-center mb-0" id="templateTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="{{route('kursus.tagihan.detail.tidak.routine',Auth::user()->name)}}" class="badge badge-sm bg-gradient-primary font-weight-bold text-xs mx-2" data-toggle="tooltip" data-original-title="Edit user">
                        Detail
                      </a>
                    </td>
                  </tr>
