                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <form action="{{ route('admin.tahun-ajaran.active', $angkatans->id) }}"
                                                ...
                                                @if ($angkatans->status == 'nonActive')
                                                    <button type="submit"
                                                        class="badge border-0 badge-sm bg-gradient-success font-weight-bold text-xxs mx-1">
                                                        <strong>On</strong>
                                                    </button>
                                                @else
                                                    <button type="submit"
                                                        class="badge border-0 badge-sm bg-gradient-secondary font-weight-bold text-xxs mx-1">
                                                        <strong>Off</strong>
                                                    </button>
                                                @endif
                                            </form>
                                            ...
                                            <form action="{{ route('admin.tahun-ajaran.destroy', $angkatans->id) }}"
                                                ...
                                                <button type="submit" style="letter-spacing: .02rem"
                                                    class="badge badge-sm bg-gradient-danger font-weight-bolder text-xxs show_confirm border-0"
                                            ...
                                            {{-- modal --}}
                                            <div class="modal fade text-start" id="modalLink{{ $angkatans->id }}"
                                                                ...
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input type="radio" name="type"
                                                                            id="Whatsapp" class="form-check-input"
                                                                            value="Whatsapp">
