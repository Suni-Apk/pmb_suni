...
@section('content')
    ...
    @if ($id == 'Routine')
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Edit Tagihan Spp <strong>>></strong> Angkatan 2023 <strong>>></strong>
                Jurusan Ilmu Fiqih <strong>>></strong> Program Belajar S1</h6>
        </nav>
        <div class="card h-100 mt-4">
            <div class="card-body p-3">
                ...
                <form action="{{ route('admin.tagihan.store') }}" method="POST">
                    @csrf
                    @method('POST')
                    <input type="hidden" name="jenis_tagihan" value="{{ $id }}">
    ...
    @if ($id == 'Tidakroutine')
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Edit Tagihan Jas <strong>>></strong> Angkatan 2020 <strong>>></strong>
                Jurusan Bahasa Arab <strong>>></strong> Program Belajar S1</h6>
        </nav>
        <div class="card h-100 mt-4">
            <div class="card-body p-3">
                <form action="{{ route('admin.tagihan.store') }}" method="POST">
                    ...
                    <ul class="list-group">
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                name="name" id="name" placeholder="Spp Tahun 2022" value="Tagihan jas">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                is-invalid
                            @enderror"
                                name="name" id="amount" placeholder="200.000" value="250.000">
                            @error('name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
    ...
    @if ($id == 'DaftarUlang')
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Edit Tagihan Daftar ulang</h6>
        </nav>
        <div class="card h-100 mt-4">
            <div class="card-body p-3">
                <form action="{{ route('admin.tagihan.store') }}" method="POST">
    ...
    @if ($id == 'Tingkatan')
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Edit Tagihan Tingkatan <strong>>></strong> Angkatan 2022
                <strong>>></strong> Program Belajar Bahasa Arab
            </h6>
        </nav>
        <div class="card h-100 mt-4">
            <div class="card-body p-3">
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-items-middle text-center">1</td>
                                    <td class="align-items-middle text-center">Mubtadi'</td>
                                    <td><input type="text" placeholder="200.000" class="form-control hasil"></td>
                                    <td><input type="date" class="form-control" value="{{ date('Y') }}-08-30">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="align-items-middle text-center">2</td>
                                    <td class="align-items-middle text-center">Muttawassith</td>
                                    <td><input type="text" placeholder="200.000" class="form-control hasil"></td>
                                    <td><input type="date" class="form-control" value="{{ date('Y') }}-09-30">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="align-items-middle text-center">3</td>
                                    <td class="align-items-middle text-center">Mutaqaddim</td>
                                    <td><input type="text" placeholder="200.000" class="form-control hasil"></td>
                                    <td><input type="date" class="form-control" value="{{ date('Y') }}-10-30">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
