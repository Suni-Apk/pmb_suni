                                ...
                                @foreach ($jurusan as $index => $jurusans )
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center justify-content-center">
                                            <a href="{{ route('admin.jurusan.show', $jurusans->id) }}" class="btn btn-sm bg-gradient-success font-weight-bold text-xs mx-2 mt-3">
                                                <i class="fas fa-eye fs-6"></i>
                                            </a>
                                        
                                            <a href="{{ route('admin.jurusan.edit', $jurusans->id) }}" class="btn btn-sm bg-gradient-secondary font-weight-bold text-xs mx-2 mt-3">
