                ...
                <tbody>
                  @forelse ($mahasiswa as $index => $item)
                    <tr class="text-center">
                        ...
                        <a href="{{route('admin.mahasiswa.edit',$item->id)}}" class="badge badge-sm bg-gradient-success font-weight-bold text-xs mx-2" data-toggle="tooltip" data-original-title="Edit user">
                            Ubah
                        </a>
