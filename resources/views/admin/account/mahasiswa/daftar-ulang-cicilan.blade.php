            ...
            <div class="col-12 col-sm-12">
                <div class="card border border-lg shadow-lg">
                    <div class="card-header">
                        <h4 class="text-center">Pembayaran Daftar Ulang cicilan {{ $mahasiswa->name }}</h4>
                    </div>
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <div class="row">
                            ...
                            <form action="{{ route('admin.transactions.cicilan.bayar', $mahasiswa->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="no_invoice" value="{{ $transaction->no_invoice }}">
                                <div class="col-12 col-sm-12">
